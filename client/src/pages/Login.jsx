  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <h1 className="font-[var(--font-display)] text-2xl font-extrabold mb-1 text-center">Sign in</h1>
        <p className="text-[var(--color-ink-dim)] text-sm mb-6 text-center">Track buses and trains in real time.</p>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-bold text-[var(--color-ink-dim)] mb-1.5 uppercase tracking-wide">Email</label>
            <div className="relative">
              <Mail size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--color-ink-dim)]" />
              <input
                type="email"
                required
                value={form.email}
          ...
          <div>
            ...
            <div className="relative">
              <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--color-ink-dim)]" />
              <input
                type="password"
                required
                value={form.password}
        ...
        <p className="text-sm text-[var(--color-ink-dim)] mt-4 text-center">
          No account?{' '}
          <Link to="/register" className="text-[var(--color-primary)] font-bold hover:underline">Register</Link>
        </p>
      </div>
    </div>
  );
